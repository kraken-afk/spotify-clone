...
export default function FooterSection(): ReactElement {
  return (
    <footer className="pb-8 sm:p-4 text-sm sm:text-lg my-4 sm:my-16 sm:min-h-[7rem] border-t-neutral-700 border-t-[1px] border-solid flex justify-center items-center flex-col text-center">
