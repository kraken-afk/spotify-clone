...
export default function SkeletonBadge(): ReactElement {
  return (
    <div className="flex gap-2 w-[300px]  bg-black-expose rounded-sm overflow-hidden hover:bg-neutral-700 transition-all duration-75 cursor-pointer items-center">
